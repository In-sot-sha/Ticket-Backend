...
CREATE TABLE `Organization` (
    ...
    `serviceFeePercent` DOUBLE NOT NULL DEFAULT 5.0,
...
CREATE TABLE `Event` (
    ...
    `vendorApprovalMode` VARCHAR(191) NOT NULL DEFAULT 'auto',
    `refundPolicy` TEXT NULL,
    `socialLinks` JSON NULL,
    `gateTicketing` BOOLEAN NOT NULL DEFAULT false,

    UNIQUE INDEX `Event_slug_key`(`slug`),
    INDEX `Event_isPublished_startDate_idx`(`isPublished`, `startDate`),
...
CREATE TABLE `VendorApplication` (
    ...
    `processingFee` DOUBLE NOT NULL DEFAULT 0,
    `netAmount` DOUBLE NOT NULL DEFAULT 0,
    `stallNumber` VARCHAR(191) NULL,
    `appliedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `approvedAt` DATETIME(3) NULL,
    `rejectedAt` DATETIME(3) NULL,

    UNIQUE INDEX `VendorApplication_userId_eventId_vendorTypeId_key`(`userId`, `eventId`, `vendorTypeId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TicketType` (
    ...
    `maxPerPerson` INTEGER NULL DEFAULT 5,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `Otp` (
    ...
    INDEX `Otp_contact_idx`(`contact`),
    INDEX `Otp_expiresAt_idx`(`expiresAt`),
    UNIQUE INDEX `Otp_contact_key`(`contact`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
